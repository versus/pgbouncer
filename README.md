...
* `latest` ([Dockerfile](https://github.com/versus/docker-pgbouncer/blob/master/Dockerfile)) - Default and latest version.
* `1.21.0` ([Dockerfile](https://github.com/versus/docker-pgbouncer/blob/v1.21.x/Dockerfile)) - Latest version.
* `1.20.1` ([Dockerfile](https://github.com/versus/docker-pgbouncer/blob/v1.20.x/Dockerfile)) - Latest version.
* `1.19.1` ([Dockerfile](https://github.com/versus/docker-pgbouncer/blob/v1.19.x/Dockerfile)) - Latest version.
* `1.18.0` ([Dockerfile](https://github.com/versus/docker-pgbouncer/blob/v1.18.x/Dockerfile)) - Latest version.
* `1.17.0` ([Dockerfile](https://github.com/versus/docker-pgbouncer/blob/v1.17.x/Dockerfile)) - Latest version.
* `1.15.0` ([Dockerfile](https://github.com/versus/docker-pgbouncer/blob/v1.15.x/Dockerfile)) - Latest version.
* `1.14.0` ([Dockerfile](https://github.com/versus/docker-pgbouncer/blob/v1.14.x/Dockerfile)) - Latest version.
* `1.12.0` ([Dockerfile](https://github.com/versus/docker-pgbouncer/blob/v1.12.x/Dockerfile)) - Latest version.
...
Almost all settings found in the [pgbouncer.ini](https://pgbouncer.github.io/config.html) can be defined as environment variables, except a few that make little sense in a Docker environment (like port numbers, syslog and pid settings). See the [entrypoint script](https://github.com/versus/docker-pgbouncer/blob/master/entrypoint.sh) for details. For example:
...
For example in Kubernetes, see the [examples/kubernetes folder](https://github.com/versus/docker-pgbouncer/tree/master/examples/kubernetes).

Docker Compose
--------------

For example in Docker Compose, see the [examples/docker-compose folder](https://github.com/versus/docker-pgbouncer/tree/master/examples/docker-compose).
...
```Dockerfile
FROM versusua/pgbouncer:1.11.0
...
Use [examples/generate-userlist](https://github.com/versus/docker-pgbouncer/blob/master/examples/generate-userlist) to generate this file:
